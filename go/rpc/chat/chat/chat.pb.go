...
var file_chat_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x22, 0x47, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x18, 0x0a,
	...
	0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x74, 0x6f, 0x22, 0x2a, 0x0a, 0x04, 0x55,
	...
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x70, 0x22, 0x1a, 0x0a, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c,
	0x74, 0x12, 0x10, 0x0a, 0x03, 0x72, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x03,
	0x72, 0x65, 0x73, 0x32, 0x60, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x2b, 0x0a, 0x07, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x0d, 0x2e,
	...
	0x24, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x0a, 0x2e, 0x63, 0x68,
	0x61, 0x74, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x1a, 0x0c, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x52,
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x0c, 0x5a, 0x0a, 0x63, 0x68, 0x61, 0x74, 0x2f, 0x3b, 0x63,
...
var file_chat_proto_goTypes = []interface{}{
	...
	(*Result)(nil),  // 2: chat.Result
}
var file_chat_proto_depIdxs = []int32{
	0, // 0: chat.ChatService.Channel:input_type -> chat.Message
	1, // 1: chat.ChatService.Register:input_type -> chat.User
	0, // 2: chat.ChatService.Channel:output_type -> chat.Message
	2, // 3: chat.ChatService.Register:output_type -> chat.Result
...
func (c *chatServiceClient) Channel(ctx context.Context, opts ...grpc.CallOption) (ChatService_ChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ChatService_serviceDesc.Streams[0], "/chat.ChatService/Channel", opts...)
	if err != nil {
		return nil, err
	}
	x := &chatServiceChannelClient{stream}
	return x, nil
}
...
func (x *chatServiceChannelClient) Send(m *Message) error {
	return x.ClientStream.SendMsg(m)
}

func (x *chatServiceChannelClient) Recv() (*Message, error) {
	m := new(Message)
...
func (c *chatServiceClient) Register(ctx context.Context, in *User, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
func (*UnimplementedChatServiceServer) Register(context.Context, *User) (*Result, error) {
...
func (x *chatServiceChannelServer) Send(m *Message) error {
	return x.ServerStream.SendMsg(m)
}

func (x *chatServiceChannelServer) Recv() (*Message, error) {
	m := new(Message)
